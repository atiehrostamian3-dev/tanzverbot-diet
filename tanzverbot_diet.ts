...
//Die Struktur für Lebensmittel definieren
...
//Standardliste der Tans-Verboot-Diät
export const dietFoods: FoodItem[] = [
...
export function calcDateOnDiet(
  foodItems: FoodItem[], //Die Liste der Lebensmittel wird nun als Eingabe akzeptiert.
  ...
  //Nun verwenden wir die Liste, die an die Funktion übergeben wurde.
